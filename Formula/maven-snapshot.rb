class MavenSnapshot < Formula
  ...
  url "https://ci-builds.apache.org/job/Maven/job/maven-box/job/maven/job/master/46/artifact/org/apache/maven/apache-maven/3.7.0-SNAPSHOT/apache-maven-3.7.0-SNAPSHOT-bin.tar.gz"
